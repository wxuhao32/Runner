...
import { Heart, Zap, Trophy, MapPin, Diamond, Rocket, ArrowUpCircle, Shield, Activity, PlusCircle, Play, ArrowLeft, ArrowRight, ArrowUp } from 'lucide-react';
        ...
        <div className="absolute inset-x-0 bottom-0 p-6 pb-8 flex justify-between items-end pointer-events-none z-[60]">
            ...
            <div className="flex gap-4 pointer-events-auto">
                <button 
                    ...
                    onPointerDown={(e) => { e.preventDefault(); trigger('control-left'); }}
                >
                    <ArrowLeft className="w-8 h-8 text-cyan-400" />
                </button>
                <button 
                    className="w-16 h-16 rounded-full bg-white/10 border-2 border-white/20 backdrop-blur-md flex items-center justify-center active:bg-white/30 active:scale-95 transition-all touch-none"
                    onPointerDown={(e) => { e.preventDefault(); trigger('control-right'); }}
                >
            ...
            <div className="flex gap-4 items-end pointer-events-auto">
                 ...
                 <button 
                    ...
                    onPointerDown={(e) => { e.preventDefault(); trigger('control-action'); }}
                >
                ...
                <button 
                    ...
                    onPointerDown={(e) => { e.preventDefault(); trigger('control-jump'); }}
                >
